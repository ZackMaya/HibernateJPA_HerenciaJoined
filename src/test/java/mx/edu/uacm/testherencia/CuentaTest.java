...
import mx.edu.uacm.herencia.HibernateJpaHerenciaJoinedApplication;
import mx.edu.uacm.herencia.domain.CuentaCredito;
import mx.edu.uacm.herencia.domain.CuentaDebito;

@RunWith(SpringJUnit4ClassRunner.class)
@SpringBootTest(classes =HibernateJpaHerenciaJoinedApplication.class)
public class CuentaTest {
	...
	public void testGuardarCuenta() {
		...
		cuentaCredito.setTitular("Hugo Hernandez");
		...
		cuentaDebito.setTitular("Hugo Hernandez");
